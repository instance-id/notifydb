...
class CustomCodeBox extends StatefulWidget {
  ...
  const CustomCodeBox({Key? key,required this.text , required this.language, required this.theme}) : super(key: key);
...
class InnerField extends StatefulWidget {
  ...
  const InnerField({Key? key, required this.text, required this.language, required this.theme}) : super(key: key);
